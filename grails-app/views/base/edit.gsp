...
<html>
	...
	<body>
		<a href="#edit-base" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-base" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:baseInstance, action:'update']" method="PUT"  enctype="multipart/form-data">
